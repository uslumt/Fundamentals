# 1 "./Software_Engineering/C++/hello.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "./Software_Engineering/C++/hello.cpp" 2
# 1 "./Software_Engineering/C++/Include/mymath.h" 1





# 5 "./Software_Engineering/C++/Include/mymath.h"
int myadd(int, int);
# 3 "./Software_Engineering/C++/hello.cpp" 2
